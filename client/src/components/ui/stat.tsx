...
export const StatValueText = forwardRef<HTMLDivElement, StatValueTextProps>((props, ref) => {
...
export const StatUpTrend = forwardRef<HTMLDivElement, BadgeProps>((props, ref) => (
...
export const StatDownTrend = forwardRef<HTMLDivElement, BadgeProps>((props, ref) => (
