...
export const FileUploadRoot = forwardRef<HTMLInputElement, FileUploadRootProps>((props, ref) => {
...
export const FileUploadList = forwardRef<HTMLUListElement, FileUploadListProps>((props, ref) => {
