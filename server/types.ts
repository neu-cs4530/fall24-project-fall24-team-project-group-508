...
export interface UpdateSettingRequest {
  body: {
    theme: 'light' | 'dark' | 'northeastern' | 'oceanic' | 'highContrast' | 'colorblindFriendly';        // Whether dark mode is enabled or not
...
export interface Account {
  ...
  settings: {theme: 'light' | 'dark' | 'northeastern' | 'oceanic' | 'highContrast' | 'colorblindFriendly';
    textSize: 'small' | 'medium' | 'large';
    screenReader: boolean;};
}
